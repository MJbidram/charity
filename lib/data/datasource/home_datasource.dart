...
class HomeDataRemote implements HomeDataSource {
  ...
  late List<HomeImageSliderModel> homeImageSlider;
  ...
  Future<List> getHomeData() async {
    try {
      ...
      if (homeDataResponse.statusCode == 200) {
        ...
        homeImageSlider = homeDataResponse.data['data']['slider']
            .map((jsonObject) => HomeImageSliderModel.fromJsonMap(jsonObject))
            .toList()
            .cast<HomeImageSliderModel>();
